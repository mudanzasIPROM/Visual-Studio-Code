...
`.content);styleMod.register("realbox-dropdown-shared-style");function getTemplate$6(){return html`<!--_html_template_start_--><style include="cr-hidden-style cr-icons realbox-dropdown-shared-style">
  :host {
    display: block;
    outline: none;
  }
...
<cr-dialog id="dialog" show-on-attach>
  ...
  <div slot="body">
    <div id="buttons">
      ...
      <cr-button id="emailButton" title="Correo electrónico" on-click="onEmailClick_">
      </cr-button>
    </div>
    <cr-input readonly="readonly" label="Enlace del doodle" id="url" value="[[url.url]]">
      <cr-icon-button id="copyButton" slot="suffix" title="Copiar enlace" on-click="onCopyClick_">
      </cr-icon-button>
    </cr-input>
  </div>
  ...
  <div id="doodle" title="[[doodle_.description]]">
    <div id="imageDoodle" hidden="[[!imageDoodle_]]" tabindex$="[[imageDoodleTabIndex_]]" on-click="onImageClick_" on-keydown="onImageKeydown_">
      <div id="imageContainer">
        ...
        <cr-button id="shareButton" title="Compartir doodle" on-click="onShareButtonClick_" hidden="[[!imageDoodle_.shareButton]]">
...
`;document.head.appendChild(template.content);function getTemplate$1(){return html`<!--_html_template_start_--><style include="cr-hidden-style">
  :host {
    border-radius: 8px;
  ...
  <dom-if if="[[lazyRender_]]" on-dom-change="onLazyRendered_">
    <template>
      ...
      <div id="customizeButtonContainer">
        <cr-button id="customizeButton" on-click="onCustomizeClick_" title="Personalizar esta página" aria-pressed="[[showCustomize_]]">
